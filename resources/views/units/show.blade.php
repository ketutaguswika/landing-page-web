    ...
    <div class="absolute inset-0 bg-black/40 flex items-center">
        <div class="max-w-7xl mx-auto px-6 w-full">
            <nav class="flex mb-4 text-white/80 text-sm tracking-widest uppercase">
                <a href="{{ route('home') }}" class="hover:text-resort-gold">Home</a>
                <span class="mx-2">/</span>
                <span class="text-resort-gold">Product Detail</span>
            </nav>
            <h1 class="text-5xl md:text-7xl font-serif font-black text-white uppercase tracking-tighter italic">
                {{ $unit->nama_tipe }}
            </h1>
        </div>
    </div>
...
<section class="py-20 px-6 bg-white">
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-16">
        ...
        <div class="lg:col-span-2">
            <div class="flex flex-wrap gap-8 mb-12 border-b border-gray-100 pb-8">
                ...
                <div class="flex flex-col border-x border-gray-100 px-8">
        ...
        <div class="lg:col-span-1">
            <div class="bg-resort-green p-8 rounded-xl shadow-2xl sticky top-24">
                <h4 class="text-resort-gold text-xs font-bold uppercase tracking-[0.3em] mb-2">Interested in this unit?</h4>
                <h3 class="text-white text-2xl font-serif font-bold mb-6 italic">Miliki Hunian Impian Anda Sekarang</h3>
                ...
                <a href="https://wa.me/6282178878998?text=Halo, saya tertarik dengan unit {{ $unit->nama_tipe }} di Green Resort Palembang." 
                   target="_blank"
