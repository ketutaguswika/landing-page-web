    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 items-start">
        ...
        <div class="text-center md:text-left md:col-span-2 lg:pr-12">
            <div class="flex items-center justify-center md:justify-start gap-5 mb-6">
                ...
                <h2 class="flex flex-col leading-tight font-serif uppercase text-left justify-center">
        <span class="text-3xl md:text-4xl font-black tracking-tighter text-white">
            GREEN RESORT
        </span>
        <span class="text-xs md:text-sm font-bold text-resort-gold tracking-[0.4em] mt-1 md:mt-0">
            PALEMBANG
        </span>
    </h2>
            </div>
